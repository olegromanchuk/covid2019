...
a._heightCalc();a._dte._animate(c.wrapper,{opacity:1,top:0},b);a._dte._animate(c.background,{opacity:1});setTimeout(function(){d("div.DTE_Footer").css("text-indent",-1)},10);c.close.attr("title",a._dte.i18n.close).bind("click.DTED_Lightbox",function(b){a._dte.close()});d(a._dte.dom.formError).appendTo(a._dte.dom.bodyContent);c.background.bind("click.DTED_Lightbox",function(b){a._dte.background()});d("div.DTED_Lightbox_Content_Wrapper",c.wrapper).bind("click.DTED_Lightbox",function(b){d(b.target).hasClass("DTED_Lightbox_Content_Wrapper")&&
a._dte.background()});d(q).bind("resize.DTED_Lightbox",function(){a._heightCalc()});a._scrollTop=d("body").scrollTop();q.orientation!==l&&(b=d("body").children().not(c.background).not(c.wrapper),d("body").append('<div class="DTED_Lightbox_Shown"></div>'),d("div.DTED_Lightbox_Shown").append(b))},_heightCalc:function(){var b=a._dom,c=d(q).height()-2*a.conf.windowPadding-d("div.DTE_Header",b.wrapper).outerHeight()-d("div.DTE_Footer",b.wrapper).outerHeight();d("div.DTE_Body_Content",b.wrapper).css("maxHeight",
c)},_hide:function(b){var c=a._dom;b||(b=function(){});if(q.orientation!==l){var e=d("div.DTED_Lightbox_Shown");e.children().appendTo("body");e.remove()}d("body").removeClass("DTED_Lightbox_Mobile").scrollTop(a._scrollTop);a._dte._animate(c.wrapper,{opacity:0,top:a.conf.offsetAni},function(){d(this).detach();b()});a._dte._animate(c.background,{opacity:0},function(){d(this).detach()});c.close.unbind("click.DTED_Lightbox");c.background.unbind("click.DTED_Lightbox");d("div.DTED_Lightbox_Content_Wrapper",
...
this;d.each(this._fieldNames(a),function(a,d){b.field(d).enable()});return this};f.prototype.error=function(a,b){b===l?(this._message(this.dom.formError,a),this.s.globalError=a):this.field(a).error(b);return this};f.prototype.field=function(a){var b=this.s.fields;if(!b[a])throw"Unknown field name - "+a;return b[a]};f.prototype.fields=function(){return d.map(this.s.fields,function(a,b){return b})};f.prototype.file=H;f.prototype.files=I;f.prototype.get=function(a){var b=this;a||(a=this.fields());if(d.isArray(a)){var c=
{};d.each(a,function(a,d){c[d]=b.field(d).get()});return c}return this.field(a).get()};f.prototype.hide=function(a,b){var c=this;d.each(this._fieldNames(a),function(a,d){c.field(d).hide(b)});return this};f.prototype.ids=function(a){return d.map(this.s.editFields,function(b,c){return!0===a?"#"+c:c})};f.prototype.inError=function(a){d(this.dom.formError);if(this.s.globalError)return!0;a=this._fieldNames(a);for(var b=0,c=a.length;b<c;b++)if(this.field(a[b]).inError())return!0;return!1};f.prototype.inline=
function(a,b,c){var e=this;d.isPlainObject(b)&&(c=b,b=l);c=d.extend({},this.s.formOptions.inline,c);var k=this._dataSource("individual",a,b),g,h,f=0,m,t=!1,n=this.classes.inline;d.each(k,function(a,b){if(0<f)throw"Cannot edit more than one row inline at a time";g=d(b.attach[0]);m=0;d.each(b.displayFields,function(a,b){if(0<m)throw"Cannot edit more than one field inline at a time";h=b;m++});f++});if(d("div.DTE_Field",g).length||this._tidy(function(){e.inline(a,b,c)}))return this;this._edit(a,k,"inline",
c,function(){var a=e._formOptions(c);if(!e._preopen("inline"))return e;var b=g.contents().detach(),k=-1!==navigator.userAgent.indexOf("Edge/")?'style="width:'+g.width()+'px"':"";g.append(d('<div class="'+n.wrapper+'"><div class="'+n.liner+'" '+k+'><div class="DTE_Processing_Indicator"><span></span></div></div><div class="'+n.buttons+'"></div></div>'));g.find("div."+n.liner.replace(/ /g,".")).append(h.node()).append(e.dom.formError);c.buttons&&g.find("div."+n.buttons.replace(/ /g,".")).append(e.dom.buttons);
e._closeReg(function(c,h){t=!0;d(r).off("click"+a);c&&"edit"===h||(g.contents().detach(),g.append(b));e._clearDynamicInfo();return"inline"});setTimeout(function(){if(!t)d(r).on("click"+a,function(a){var b=d.fn.addBack?"addBack":"andSelf";h._typeFn("owns",a.target)||-1!==d.inArray(g[0],d(a.target).parents()[b]())||e.blur()})},0);e._focus([h],c.focus);e._postopen("inline",!0)});return this};f.prototype.message=function(a,b){b===l?this._message(this.dom.formInfo,a):this.field(a).message(b);return this};
f.prototype.mode=function(a){if(!a)return this.s.action;if(!this.s.action)throw Error("Not currently in an editing mode");if("create"===this.s.action&&"create"!==a)throw Error("Changing from create mode is not supported");this.s.action=a;return this};f.prototype.modifier=function(){return this.s.modifier};f.prototype.multiGet=function(a){var b=this;a===l&&(a=this.fields());if(d.isArray(a)){var c={};d.each(a,function(a,d){c[d]=b.field(d).multiGet()});return c}return this.field(a).multiGet()};f.prototype.multiSet=
function(a,b){var c=this;d.isPlainObject(a)&&b===l?d.each(a,function(a,b){c.field(a).multiSet(b)}):this.field(a).multiSet(b);return this};f.prototype.node=function(a){var b=this;a||(a=this.order());return d.isArray(a)?d.map(a,function(a){return b.field(a).node()}):this.field(a).node()};f.prototype.off=function(a,b){d(this).off(this._eventName(a),b);return this};f.prototype.on=function(a,b){d(this).on(this._eventName(a),b);return this};f.prototype.one=function(a,b){d(this).one(this._eventName(a),b);
return this};f.prototype.open=function(){var a=this;this._displayReorder();this._closeReg(function(){a.s.displayController.close(a,function(){a._clearDynamicInfo();a._event("closed",["main"])})});if(!this._preopen("main"))return this;this.s.displayController.open(this,this.dom.wrapper,function(){a._focus(d.map(a.s.order,function(b){return a.s.fields[b]}),a.s.editOpts.focus);a._event("opened",["main",a.s.action])});this._postopen("main",!1);return this};f.prototype.order=function(a){if(!a)return this.s.order;
arguments.length&&!d.isArray(a)&&(a=Array.prototype.slice.call(arguments));if(this.s.order.slice().sort().join("-")!==a.slice().sort().join("-"))throw"All fields, and no additional fields, must be provided for ordering.";d.extend(this.s.order,a);this._displayReorder();return this};f.prototype.remove=function(a,b,c,e,k){var g=this;if(this._tidy(function(){g.remove(a,b,c,e,k)}))return this;a.length===l&&(a=[a]);var h=this._crudArgs(b,c,e,k),f=this._dataSource("fields",a);this.s.action="remove";this.s.modifier=
a;this.s.editFields=f;this.dom.form.style.display="none";this._actionClass();this._event("initRemove",[F(f,"node"),F(f,"data"),a],function(){g._event("initMultiRemove",[f,a],function(){g._assembleMain();g._formOptions(h.opts);h.maybeOpen();var a=g.s.editOpts;null!==a.focus&&d("button",g.dom.buttons).eq(a.focus).focus()})});return this};f.prototype.set=function(a,b){var c=this;if(!d.isPlainObject(a)){var e={};e[a]=b;a=e}d.each(a,function(a,b){c.field(a).set(b)});return this};f.prototype.show=function(a,
b){var c=this;d.each(this._fieldNames(a),function(a,d){c.field(d).show(b)});return this};f.prototype.submit=function(a,b,c,e){var k=this,g=this.s.fields,h=[],f=0,m=!1;if(this.s.processing||!this.s.action)return this;this._processing(!0);var l=function(){h.length!==f||m||k._event("initSubmit",[k.s.action],function(d){!1===d?k._processing(!1):(m=!0,k._submit(a,b,c,e))})};this.error();d.each(g,function(a,b){b.inError()&&h.push(a)});d.each(h,function(a,b){g[b].error("",function(){f++;l()})});l();return this};
f.prototype.template=function(a){if(a===l)return this.s.template;this.s.template=null===a?null:d(a);return this};f.prototype.title=function(a){var b=d(this.dom.header).children("div."+this.classes.header.content);if(a===l)return b.html();"function"===typeof a&&(a=a(this,new v.Api(this.s.table)));b.html(a);return this};f.prototype.val=function(a,b){return b!==l||d.isPlainObject(a)?this.set(a,b):this.get(a)};var B=v.Api.register;B("editor()",function(){return w(this)});B("row.create()",function(a){var b=
w(this);b.create(C(b,a,"create"));return this});B("row().edit()",function(a){var b=w(this);b.edit(this[0][0],C(b,a,"edit"));return this});B("rows().edit()",function(a){var b=w(this);b.edit(this[0],C(b,a,"edit"));return this});B("row().delete()",function(a){var b=w(this);b.remove(this[0][0],C(b,a,"remove",1));return this});B("rows().delete()",function(a){var b=w(this);b.remove(this[0],C(b,a,"remove",this[0].length));return this});B("cell().edit()",function(a,b){a?d.isPlainObject(a)&&(b=a,a="inline"):
a="inline";w(this)[a](this[0][0],b);return this});B("cells().edit()",function(a){w(this).bubble(this[0],a);return this});B("file()",H);B("files()",I);d(r).on("xhr.dt",function(a,b,c){"dt"===a.namespace&&c&&c.files&&d.each(c.files,function(a,b){f.files[a]||(f.files[a]={});d.extend(f.files[a],b)})});f.error=function(a,b){throw b?a+" For more information, please refer to https://datatables.net/tn/"+b:a;};f.pairs=function(a,b,c){var e;b=d.extend({label:"label",value:"value"},b);if(d.isArray(a)){var k=
0;for(e=a.length;k<e;k++){var g=a[k];d.isPlainObject(g)?c(g[b.value]===l?g[b.label]:g[b.value],g[b.label],k,g.attr):c(g,g,k)}}else k=0,d.each(a,function(a,b){c(b,a,k);k++})};f.safeId=function(a){return a.replace(/\./g,"-")};f.upload=function(a,b,c,e,k){var g=new FileReader,h=0,z=[];a.error(b.name,"");"function"===typeof b.ajax?b.ajax(c,function(b){k.call(a,b)}):(e(b,b.fileReadText||"<i>Uploading file</i>"),g.onload=function(m){var t=new FormData;t.append("action","upload");t.append("uploadField",
...
a});c.data=c.data[e];"edit"===b&&(c.id=e)}else c.id=d.map(c.data,function(a,b){return b}),delete c.data;else!c.data&&c.row?c.data=[c.row]:c.data||(c.data=[])};f.prototype._optionsUpdate=function(a){var b=this;a.options&&d.each(this.s.fields,function(c,d){a.options[c]!==l&&(d=b.field(c))&&d.update&&d.update(a.options[c])})};f.prototype._message=function(a,b){var c=d.fn.animate?!0:!1;"function"===typeof b&&(b=b(this,new v.Api(this.s.table)));a=d(a);c&&a.stop();b?this.s.displayed&&c?a.html(b).fadeIn():
a.html(b).css("display","block"):this.s.displayed&&c?a.fadeOut(function(){a.html("")}):a.html("").css("display","none")};f.prototype._multiInfo=function(){var a=this.s.fields,b=this.s.includeFields,c=!0;if(b)for(var d=0,k=b.length;d<k;d++){var g=a[b[d]];var h=g.multiEditable();g.isMultiValue()&&h&&c?(g=!0,c=!1):g=g.isMultiValue()&&!h?!0:!1;a[b[d]].multiInfoShown(g)}};f.prototype._postopen=function(a,b){var c=this,e=this.s.displayController.captureFocus;e===l&&(e=!0);d(this.dom.form).off("submit.editor-internal").on("submit.editor-internal",
function(a){a.preventDefault()});if(e&&("main"===a||"bubble"===a))d("body").on("focus.editor-focus",function(){0===d(r.activeElement).parents(".DTE").length&&0===d(r.activeElement).parents(".DTED").length&&c.s.setFocus&&c.s.setFocus.focus()});this._multiInfo();this._event("open",[a,this.s.action]);b&&this._event("opened",[a,this.s.action]);return!0};f.prototype._preopen=function(a){if(!1===this._event("preOpen",[a,this.s.action]))return this._clearDynamicInfo(),this._event("cancelOpen",[a,this.s.action]),
"inline"!==this.s.mode&&"bubble"!==this.s.mode||!this.s.closeIcb||this.s.closeIcb(),this.s.closeIcb=null,!1;this.s.displayed=a;return!0};f.prototype._processing=function(a){var b=this.classes.processing.active;d(["div.DTE",this.dom.wrapper]).toggleClass(b,a);this.s.processing=a;this._event("processing",[a])};f.prototype._submit=function(a,b,c,e){var k=this,g=!1,h={},f={},m=v.ext.oApi._fnSetObjectDataFn,t=this.s.fields,n=this.s.editCount,p=this.s.editFields,u=this.s.editData,A=this.s.editOpts,D=A.submit,
E=this.s.action,x={data:{}};x[this.s.actionName]=E;this.s.dbTable&&(x.table=this.s.dbTable);if("create"===E||"edit"===E)if(d.each(p,function(a,b){var c={},e={};d.each(t,function(h,k){if(b.fields[h]&&k.submittable()){var f=k.multiGet(),p=m(h);if(f[a]===l)h=k.valFromData(b.data),p(c,h);else{f=f[a];var n=d.isArray(f)&&-1!==h.indexOf("[]")?m(h.replace(/\[.*$/,"")+"-many-count"):null;p(c,f);n&&n(c,f.length);"edit"!==E||u[h]&&k.compare(f,u[h][a])||(p(e,f),g=!0,n&&n(e,f.length))}}});d.isEmptyObject(c)||
(h[a]=c);d.isEmptyObject(e)||(f[a]=e)}),"create"===E||"all"===D||"allIfChanged"===D&&g)x.data=h;else if("changed"===D&&g)x.data=f;else{this.s.action=null;if("close"===A.onComplete&&(e===l||e))this._close(!1);else if("function"===typeof A.onComplete)A.onComplete(this);a&&a.call(this);this._processing(!1);this._event("submitComplete");return}else"remove"===E&&d.each(p,function(a,b){x.data[a]=b.data});this._legacyAjax("send",E,x);var L=d.extend(!0,{},x);c&&c(x);!1===this._event("preSubmit",[x,E])?this._processing(!1):
(this.s.ajax||this.s.ajaxUrl?this._ajax:this._submitTable).call(this,x,function(c,d,g){k._submitSuccess(c,d,x,L,k.s.action,n,e,a,b,g)},function(a,c,d){k._submitError(a,c,d,b,x,k.s.action)},x)};f.prototype._submitTable=function(a,b,c,e){var k=a.action,g={data:[]},h=v.ext.oApi._fnGetObjectDataFn(this.s.idSrc),f=v.ext.oApi._fnSetObjectDataFn(this.s.idSrc);if("remove"!==k){var m="main"===this.s.mode?this._dataSource("fields",this.modifier()):this._dataSource("individual",this.modifier());d.each(a.data,
function(a,b){var c=d.fn.dataTableExt.oApi._fnExtend;if("edit"===k){var e=c({},m[a].data,!0);e=c(e,b,!0)}else e=c({},b,!0);b=h(e);"create"===k&&b===l?f(e,+new Date+""+a):f(e,b);g.data.push(e)})}b(g)};f.prototype._submitSuccess=function(a,b,c,e,k,g,h,f,m,t){var n=this,p=this.s.fields,u=this.s.editOpts,A=this.s.modifier;this._legacyAjax("receive",k,a);this._event("postSubmit",[a,c,k,t]);a.error||(a.error="");a.fieldErrors||(a.fieldErrors=[]);if(b||a.error||a.fieldErrors.length){var D=[];a.error&&D.push(a.error);
d.each(a.fieldErrors,function(a,b){var c=p[b.name];if(c)if(c.displayed()){if(c.error(b.status||"Error"),0===a)if("focus"===u.onFieldError)n._animate(d(n.dom.bodyContent,n.s.wrapper),{scrollTop:d(c.node()).position().top},500),c.focus();else if("function"===typeof u.onFieldError)u.onFieldError(n,b)}else D.push(c.name()+": "+(b.status||"Error"));else throw Error("Unknown field: "+b.name);});this.error(D.join("<br>"));this._event("submitUnsuccessful",[a]);m&&m.call(n,a)}else{b={};if(!a.data||"create"!==
k&&"edit"!==k)"remove"===k&&(this._dataSource("prep",k,A,e,a,b),this._event("preRemove",[a,this.ids()]),this._dataSource("remove",A,p,b),this._event(["remove","postRemove"],[a,this.ids()]),this._dataSource("commit",k,A,a.data,b));else{this._dataSource("prep",k,A,e,a,b);for(e=0;e<a.data.length;e++){var z=a.data[e];c=this._dataSource("id",z);this._event("setData",[a,z,k]);"create"===k?(this._event("preCreate",[a,z,c]),this._dataSource("create",p,z,b),this._event(["create","postCreate"],[a,z,c])):"edit"===
k&&(this._event("preEdit",[a,z,c]),this._dataSource("edit",A,p,z,b),this._event(["edit","postEdit"],[a,z,c]))}this._dataSource("commit",k,A,a.data,b)}if(g===this.s.editCount)if(k=this.s.action,this.s.action=null,"close"===u.onComplete&&(h===l||h))this._close(a.data?!0:!1,k);else if("function"===typeof u.onComplete)u.onComplete(this);f&&f.call(n,a);this._event("submitSuccess",[a,z,k])}this._processing(!1);this._event("submitComplete",[a,z,k])};f.prototype._submitError=function(a,b,c,d,k,g){this._event("postSubmit",
...
function(d,g){if(e&&g)c.one("draw",a);else setTimeout(function(){b.s&&a()},10)});else setTimeout(function(){b.s&&a()},10)}).blur(),!0):!1};f.prototype._weakInArray=function(a,b){for(var c=0,d=b.length;c<d;c++)if(a==b[c])return c;return-1};f.defaults={table:null,ajaxUrl:null,fields:[],display:"lightbox",ajax:null,idSrc:"DT_RowId",events:{},i18n:{close:"Close",create:{button:"New",title:"Create new entry",submit:"Create"},edit:{button:"Edit",title:"Edit entry",submit:"Update"},remove:{button:"Delete",
title:"Delete",submit:"Delete",confirm:{_:"Are you sure you wish to delete %d rows?",1:"Are you sure you wish to delete 1 row?"}},error:{system:'A system error has occurred (<a target="_blank" href="//datatables.net/tn/12">More information</a>).'},multi:{title:"Multiple values",info:"The selected items contain different values for this input. To edit and set all items for this input to the same value, click or tap here, otherwise they will retain their individual values.",restore:"Undo changes",noMulti:"This input can be edited individually, but not part of a group."},
datetime:{previous:"Previous",next:"Next",months:"January February March April May June July August September October November December".split(" "),weekdays:"Sun Mon Tue Wed Thu Fri Sat".split(" "),amPm:["am","pm"],hours:"Hour",minutes:"Minute",seconds:"Second",unknown:"-"}},formOptions:{bubble:d.extend({},f.models.formOptions,{title:!1,message:!1,buttons:"_basic",submit:"changed"}),inline:d.extend({},f.models.formOptions,{buttons:!1,submit:"changed"}),main:d.extend({},f.models.formOptions)},legacyAjax:!1,
actionName:"action"};(function(){function a(a){var b=r;if("keyless"!==a&&(b=d('[data-editor-id="'+a+'"]'),0===b.length&&(b="string"===typeof a?d(n(a)):d(a)),0===b.length))throw"Could not find an element with `data-editor-id` or `id` of: "+a;return b}function b(b,c){b=a(b);return d('[data-editor-field="'+c+'"]',b)}function c(a,c,g){d.each(c,function(c,d){c=d.valFromData(g);c!==l&&(d=b(a,d.dataSrc()),d.filter("[data-editor-value]").length?d.attr("data-editor-value",c):d.each(function(){for(;this.childNodes.length;)this.removeChild(this.firstChild)}).html(c))})}
var e=f.dataSources={},k=function(a,b){return a.settings()[0].oFeatures.bServerSide&&"none"!==b.s.editOpts.drawType},g=function(a){a=d(a);setTimeout(function(){a.addClass("highlight");setTimeout(function(){a.addClass("noHighlight").removeClass("highlight");setTimeout(function(){a.removeClass("noHighlight")},550)},500)},20)},h=function(a,b,c,d,g){b.rows(c).indexes().each(function(c){c=b.row(c);var e=c.data(),h=g(e);h===l&&f.error("Unable to find row identifier",14);a[h]={idSrc:h,data:e,node:c.node(),
fields:d,type:"row"}})},z=function(a,b,c){a=a.settings()[0].aoColumns[c];var g=a.editField!==l?a.editField:a.mData,e={};d.each(b,function(a,b){if(d.isArray(g))for(a=0;a<g.length;a++){var c=b,h=g[a];c.name()===h&&(e[c.name()]=c)}else b.name()===g&&(e[b.name()]=b)});d.isEmptyObject(e)&&f.error("Unable to automatically determine field from source. Please specify the field name.",11);return e},m=function(a,b,c,g,e,k){b.cells(c).indexes().each(function(f){var p=b.cell(f),m=b.row(f.row).data();m=e(m);var u=
k||z(b,g,f.column),n="object"===typeof c&&c.nodeName||c instanceof d;if(a[m]){var l=a[m].attach;var t=a[m].displayFields}h(a,b,f.row,g,e);a[m].attach=l||[];a[m].attach.push(n?d(c).get(0):p.fixedNode?p.fixedNode():p.node());a[m].displayFields=t||{};d.extend(a[m].displayFields,u)})},t=function(a,b,c,d,g){b.cells(null,c).indexes().each(function(c){m(a,b,c,d,g)})},n=function(a){return"string"===typeof a?"#"+a.replace(/(:|\.|\[|\]|,)/g,"\\$1"):"#"+a};e.dataTable={id:function(a){return v.ext.oApi._fnGetObjectDataFn(this.s.idSrc)(a)},
individual:function(a,b){var c=v.ext.oApi._fnGetObjectDataFn(this.s.idSrc),g=d(this.s.table).DataTable(),e=this.s.fields,h={};if(b){d.isArray(b)||(b=[b]);var f={};d.each(b,function(a,b){f[b]=e[b]})}m(h,g,a,e,c,f);return h},fields:function(a){var b=v.ext.oApi._fnGetObjectDataFn(this.s.idSrc),c=d(this.s.table).DataTable(),g=this.s.fields,e={};!d.isPlainObject(a)||a.rows===l&&a.columns===l&&a.cells===l?h(e,c,a,g,b):(a.rows!==l&&h(e,c,a.rows,g,b),a.columns!==l&&t(e,c,a.columns,g,b),a.cells!==l&&m(e,c,
a.cells,g,b));return e},create:function(a,b){a=d(this.s.table).DataTable();k(a,this)||(b=a.row.add(b),g(b.node()))},edit:function(a,b,c,h){var f=this;a=d(this.s.table).DataTable();if(!k(a,this)||"none"===this.s.editOpts.drawType){var m=e.dataTable.id.call(this,c);try{var p=a.row(n(m))}catch(M){p=a}p.any()||(p=a.row(function(a,b,c){return m==e.dataTable.id.call(f,b)}));p.any()?(a=d.fn.dataTableExt.oApi._fnExtend,b=a({},p.data(),!0),b=a(b,c,!0),p.data(b),c=d.inArray(m,h.rowIds),h.rowIds.splice(c,1)):
p=a.row.add(c);g(p.node())}},remove:function(a,b,c){var g=this;b=d(this.s.table).DataTable();var h=c.cancelled;if(0===h.length)b.rows(a).remove();else{var f=[];b.rows(a).every(function(){var a=e.dataTable.id.call(g,this.data());-1===d.inArray(a,h)&&f.push(this.index())});b.rows(f).remove()}},prep:function(a,b,c,g,e){if("edit"===a){var h=g.cancelled||[];e.rowIds=d.map(c.data,function(a,b){return d.isEmptyObject(c.data[b])||-1!==d.inArray(b,h)?l:b})}else"remove"===a&&(e.cancelled=g.cancelled||[])},
commit:function(a,b,c,g){var h=this;b=d(this.s.table).DataTable();if(!k(b,this)&&"edit"===a&&g.rowIds.length){a=g.rowIds;g=function(a){return function(b,c,d){return a==e.dataTable.id.call(h,c)}};c=0;for(var f=a.length;c<f;c++){try{var m=b.row(n(a[c]))}catch(M){m=b}m.any()||(m=b.row(g(a[c])));m.any()&&!b.settings()[0].oFeatures.bServerSide&&m.remove()}}m=this.s.editOpts.drawType;"none"!==m&&b.draw(m)}};e.html={id:function(a){return v.ext.oApi._fnGetObjectDataFn(this.s.idSrc)(a)},initField:function(a){var b=
d('[data-editor-label="'+(a.data||a.name)+'"]');!a.label&&b.length&&(a.label=b.html())},individual:function(a,c){if(a instanceof d||a.nodeName){var g=a;c||(c=[d(a).attr("data-editor-field")]);var h=d.fn.addBack?"addBack":"andSelf";a=d(a).parents("[data-editor-id]")[h]().data("editor-id")}a||(a="keyless");c&&!d.isArray(c)&&(c=[c]);if(!c||0===c.length)throw"Cannot automatically determine field name from data source";h=e.html.fields.call(this,a);var f=this.s.fields,k={};d.each(c,function(a,b){k[b]=f[b]});
d.each(h,function(e,h){h.type="cell";if(g)e=d(g);else{e=a;for(var m=c,n=d(),p=0,l=m.length;p<l;p++)n=n.add(b(e,m[p]));e=n.toArray()}h.attach=e;h.fields=f;h.displayFields=k});return h},fields:function(a){var c={},g=e.html;if(d.isArray(a)){for(var h=0,f=a.length;h<f;h++){var k=g.fields.call(this,a[h]);c[a[h]]=k[a[h]]}return c}var m={};g=this.s.fields;a||(a="keyless");d.each(g,function(c,d){c=d.dataSrc();c=b(a,c);c=c.filter("[data-editor-value]").length?c.attr("data-editor-value"):c.html();d.valToData(m,
null===c?l:c)});c[a]={idSrc:a,data:m,node:r,fields:g,type:"row"};return c},create:function(b,d){if(d){var g=e.html.id.call(this,d);try{a(g).length&&c(g,b,d)}catch(D){}}},edit:function(a,b,d){a=e.html.id.call(this,d)||"keyless";c(a,b,d)},remove:function(b,c){a(b).remove()}}})();f.classes={wrapper:"DTE",processing:{indicator:"DTE_Processing_Indicator",active:"processing"},header:{wrapper:"DTE_Header",content:"DTE_Header_Content"},body:{wrapper:"DTE_Body",content:"DTE_Body_Content"},footer:{wrapper:"DTE_Footer",
...
b=b.cells({selected:!0}).indexes();b=e.length||b.length?{rows:d,columns:e,cells:b}:d;this.processing(!0);a.one("preOpen",function(){c.processing(!1)}).edit(b,{buttons:g.formButtons,message:g.formMessage||a.i18n.edit.message,title:g.formTitle||a.i18n.edit.title})}},remove:{extend:"selected",limitTo:["rows"],text:function(a,b,d){return a.i18n("buttons.remove",d.editor.i18n.remove.button)},className:"buttons-remove",editor:null,formButtons:{text:function(a){return a.i18n.remove.submit},action:function(a){this.submit()}},
...
"selectedSingle";a.removeSingle=d.extend({},a.remove);a.removeSingle.extend="selectedSingle"})();f.fieldTypes={};f.DateTime=function(a,b){this.c=d.extend(!0,{},f.DateTime.defaults,b);b=this.c.classPrefix;var c=this.c.i18n;if(!q.moment&&"YYYY-MM-DD"!==this.c.format)throw"Editor datetime: Without momentjs only the format 'YYYY-MM-DD' can be used";c=d('<div class="'+b+'"><div class="'+b+'-date"><div class="'+b+'-title"><div class="'+b+'-iconLeft"><button>'+c.previous+'</button></div><div class="'+b+
'-iconRight"><button>'+c.next+'</button></div><div class="'+b+'-label"><span></span><select class="'+b+'-month"></select></div><div class="'+b+'-label"><span></span><select class="'+b+'-year"></select></div></div><div class="'+b+'-calendar"></div></div><div class="'+b+'-time"><div class="'+b+'-hours"></div><div class="'+b+'-minutes"></div><div class="'+b+'-seconds"></div></div><div class="'+b+'-error"></div></div>');this.dom={container:c,date:c.find("."+b+"-date"),title:c.find("."+b+"-title"),calendar:c.find("."+
b+"-calendar"),time:c.find("."+b+"-time"),error:c.find("."+b+"-error"),input:d(a)};this.s={d:null,display:null,minutesRange:null,secondsRange:null,namespace:"editor-dateime-"+f.DateTime._instance++,parts:{date:null!==this.c.format.match(/[YMD]|L(?!T)|l/),time:null!==this.c.format.match(/[Hhm]|LT|LTS/),seconds:-1!==this.c.format.indexOf("s"),hours12:null!==this.c.format.match(/[haA]/)}};this.dom.container.append(this.dom.date).append(this.dom.time).append(this.dom.error);this.dom.date.append(this.dom.title).append(this.dom.calendar);
this._constructor()};d.extend(f.DateTime.prototype,{destroy:function(){this._hide();this.dom.container.off().empty();this.dom.input.off(".editor-datetime")},errorMsg:function(a){var b=this.dom.error;a?b.html(a):b.empty()},hide:function(){this._hide()},max:function(a){this.c.maxDate=a;this._optionsTitle();this._setCalander()},min:function(a){this.c.minDate=a;this._optionsTitle();this._setCalander()},owns:function(a){return 0<d(a).parents().filter(this.dom.container).length},val:function(a,b){if(a===
l)return this.s.d;if(a instanceof Date)this.s.d=this._dateToUtc(a);else if(null===a||""===a)this.s.d=null;else if("--now"===a)this.s.d=new Date;else if("string"===typeof a)if(q.moment){var c=q.moment.utc(a,this.c.format,this.c.momentLocale,this.c.momentStrict);this.s.d=c.isValid()?c.toDate():null}else c=a.match(/(\d{4})\-(\d{2})\-(\d{2})/),this.s.d=c?new Date(Date.UTC(c[1],c[2]-1,c[3])):null;if(b||b===l)this.s.d?this._writeOutput():this.dom.input.val(a);this.s.d||(this.s.d=this._dateToUtc(new Date));
this.s.display=new Date(this.s.d.toString());this.s.display.setUTCDate(1);this._setTitle();this._setCalander();this._setTime()},_constructor:function(){var a=this,b=this.c.classPrefix,c=function(){a.c.onChange.call(a,a.dom.input.val(),a.s.d,a.dom.input)};this.s.parts.date||this.dom.date.css("display","none");this.s.parts.time||this.dom.time.css("display","none");this.s.parts.seconds||(this.dom.time.children("div."+b+"-seconds").remove(),this.dom.time.children("span").eq(1).remove());this._optionsTitle();
...
this,b=this.s.d,c=b?b.getUTCHours():0,d=function(b){return a.c[b+"Available"]?a.c[b+"Available"]:a._range(0,59,a.c[b+"Increment"])};this._optionsTime("hours",this.s.parts.hours12?12:24,c,this.c.hoursAvailable);this._optionsTime("minutes",60,b?b.getUTCMinutes():0,d("minutes"),this.s.minutesRange);this._optionsTime("seconds",60,b?b.getSeconds():0,d("seconds"),this.s.secondsRange)},_show:function(){var a=this,b=this.s.namespace;this._position();d(q).on("scroll."+b+" resize."+b,function(){a._hide()});
d("div.DTE_Body_Content").on("scroll."+b,function(){a._hide()});d("div.dataTables_scrollBody").on("scroll."+b,function(){a._hide()});d(r).on("keydown."+b,function(b){9!==b.keyCode&&27!==b.keyCode&&13!==b.keyCode||a._hide()});setTimeout(function(){d("body").on("click."+b,function(b){d(b.target).parents().filter(a.dom.container).length||b.target===a.dom.input[0]||a._hide()})},10)},_writeOutput:function(a){var b=this.s.d,c=q.moment?q.moment.utc(b,l,this.c.momentLocale,this.c.momentStrict).format(this.c.format):
...
yearRange:25};(function(){function a(a,b){if(null===b||b===l)b=a.uploadText||"Choose file...";a._input.find("div.upload button").html(b)}function b(b,c,e,k){var g=b.classes.form.buttonInternal,h=d('<div class="editor_upload"><div class="eu_table"><div class="row"><div class="cell upload limitHide"><button class="'+g+'"></button><input type="file" '+(k?"multiple":"")+'/></div><div class="cell clearValue"><button class="'+g+'"></button></div></div><div class="row second"><div class="cell limitHide"><div class="drop"><span></span></div></div><div class="cell"><div class="rendered"></div></div></div></div></div>');
c._input=h;c._enabled=!0;c.id&&h.find("input[type=file]").attr("id",f.safeId(c.id));c.attr&&h.find("input[type=file]").attr(c.attr);a(c);if(q.FileReader&&!1!==c.dragDrop){h.find("div.drop span").text(c.dragDropText||"Drag and drop a file here to upload");var m=h.find("div.drop");m.on("drop",function(d){c._enabled&&(f.upload(b,c,d.originalEvent.dataTransfer.files,a,e),m.removeClass("over"));return!1}).on("dragleave dragexit",function(a){c._enabled&&m.removeClass("over");return!1}).on("dragover",function(a){c._enabled&&
m.addClass("over");return!1});b.on("open",function(){d("body").on("dragover.DTE_Upload drop.DTE_Upload",function(a){return!1})}).on("close",function(){d("body").off("dragover.DTE_Upload drop.DTE_Upload")})}else h.addClass("noDrop"),h.append(h.find("div.rendered"));h.find("div.clearValue button").on("click",function(a){a.preventDefault();c._enabled&&f.fieldTypes.upload.set.call(b,c,"")});h.find("input[type=file]").on("change",function(){f.upload(b,c,this.files,a,function(a){e.call(b,a);h.find("input[type=file]").val("")})});
return h}function c(a){setTimeout(function(){a.trigger("change",{editor:!0,editorSet:!0})},0)}var e=f.fieldTypes,k=d.extend(!0,{},f.models.fieldType,{get:function(a){return a._input.val()},set:function(a,b){a._input.val(b);c(a._input)},enable:function(a){a._input.prop("disabled",!1)},disable:function(a){a._input.prop("disabled",!0)},canReturnSubmit:function(a,b){return!0}});e.hidden={create:function(a){a._val=a.value;return null},get:function(a){return a._val},set:function(a,b){a._val=b}};e.readonly=
