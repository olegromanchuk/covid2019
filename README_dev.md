...
Route phone number on ***REMOVED*** to assigned IP.
...
mysqldump --extended-insert=false -d -h ***REMOVED*** -u ***REMOVED*** -p***REMOVED*** covid2019dev >> database.sql
...
echo "-A INPUT -s ***REMOVED***/24 -j ACCEPT
-A INPUT -s ***REMOVED***/24 -j ACCEPT
-A INPUT -s ***REMOVED***/24 -j ACCEPT"
